const mockmeds = [
  {
    ...
    category: ["Head", "Back", "Neck", "Face", "Body", "Foot", "Hand"],
  ...
  },
  {
    ...
    title: "Frenadol",
    image:
      "https://www.alkaseltzer.com/sites/g/files/vrxlpx29316/files/2019-12/product-original-fs-md.jpg",
    category: ["Head", "Back", "Neck", "Face", "Body", "Foot", "Hand"],
    prospect: "https://go.drugbank.com/drugs/DB13322",
    description: [
      "Unlike other antacids, Alka-Seltzer® Original contains aspirin for pain accompanying heartburn and acid indigestion. It’s also great for pain alone.",
    ],
